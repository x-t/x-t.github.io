...
"Don't touch anything. Failure is contagious. - Erlich Bachman",
"My head is so far up my own ass I can see the future. - Erlich Bachman",
"Are you a one or a zero? - Mr. Robot",
"Control is sometimes an illusion, but sometimes you need illusion to gain control. - Elliot Alderson",
"To alcohol! The cause of, and solution to, all of life's problems. - Homer Simpson",
"I’m in no condition to drive. Wait! I shouldn’t listen to myself, I’m drunk! - Homer Simpson",
"Don’t forget to bring back my car back in the morning.. just slide it under the door. - Homer Simpson",
...
"I've got you! We've got this! We've all got... each other! - Steven Universe",
"All comedy is derived from fear. - Garnet",
"You, are an experience! Make sure that you're a good experience. - Garnet",
"Mistakes happen, even when you can see the future. - Garnet",
"We were trying to be strong for you. - Garnet",
"Now, son, you don't want to drink beer. That's for daddies and kids with fake IDs. - Homer Simpson",
"Ar galima ugnį užgesinti ugnimi? - Valdas Adamkus",
...
"Mūsų dienos – kaip šventė / Kaip žydėjimas vyšnios, – / Tad skubėkim gyventi, / Nes prabėgs – nebegrįš jos. - Salomėja Nėris",
"Gyvenimas gražus, kai savo vidaus spinduliais jį nušvieti, kai savo vidaus šiluma jį sušildai. - Salomėja Nėris",
"Tai, ką širdyje žmogus nešioja, yra didelė jėga, galingesnė už geležinį ginklą. - Vytautas Landsbergis",
"Muzika visada gynė laisvę, pati būdama laisvės prieglobstis. - Vytautas Landsbergis",
"Geriu su saiku, nesu alkoholikas ir kaskart vidury dienos negeriu po 50 gramų. Bet kai su „chebra“ geriu – tai geriu. Tuomet žinau, kad kitą dieną – jokių darbų. - Vytautas Kernagis",
"Lietuva, Tėvyne mūsų, Tu didvyrių žeme, iš praeities Tavo sūnūs te stiprybę semia. – „Tautiška giesmė“, Vincas Kudirka",
"Bet kai norime pasimokyti iš praeities, tai neprivalome pamiršti ir jos tamsiųjų bruožų, kad ateityje mažiau jų turėtume. - Antanas Smetona",
"Kas lietuviška, tas turi būti ir žmogiška. - Antanas Smetona",
"An SSL error has occurred and a secure donnection to the server cannot be made. - William Shakespeare",
